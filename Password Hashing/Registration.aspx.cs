    ...
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void createAccount()
        {
            ...
            try
            {
                ...
                {
                    using (SqlCommand cmd = new SqlCommand("INSERT INTO Account VALUES(@Email, @FirstName ,@LastName ,@PasswordHash,@PasswordSalt,@DateTimeRegistered,@MobileVerified,@EmailVerified,@IV,@Key, @CreditCard)"))
                    //using (SqlCommand cmd = new SqlCommand("INSERT INTO Account VALUES(@Email, @Mobile,@Nric,@PasswordHash,@PasswordSalt,@DateTimeRegistered,@MobileVerified,@EmailVerified)"))
                    {
                        using (SqlDataAdapter sda = new SqlDataAdapter())
                        {
                            ...
                            //cmd.Parameters.AddWithValue("@Nric", tb_nric.Text.Trim());
